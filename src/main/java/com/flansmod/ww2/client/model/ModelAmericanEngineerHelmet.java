...
public class ModelAmericanEngineerHelmet extends ModelCustomArmour
{
    ...
    public ModelAmericanEngineerHelmet() {
        ...
        this.headModel[10] = new ModelRendererTurbo((ModelBase)this, 36, 87, this.textureX, this.textureY);
        this.headModel[11] = new ModelRendererTurbo((ModelBase)this, 36, 87, this.textureX, this.textureY);
        this.headModel[12] = new ModelRendererTurbo((ModelBase)this, 0, 87, this.textureX, this.textureY);
        this.headModel[13] = new ModelRendererTurbo((ModelBase)this, 0, 87, this.textureX, this.textureY);

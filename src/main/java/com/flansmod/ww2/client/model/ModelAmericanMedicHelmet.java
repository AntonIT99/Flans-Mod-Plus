...
public class ModelAmericanMedicHelmet extends ModelCustomArmour
{
    ...
    public ModelAmericanMedicHelmet() {
        this.textureX = 256;
        this.textureY = 256;
        (this.headModel = new ModelRendererTurbo[14])[0] = new ModelRendererTurbo((ModelBase)this, 1, 1, this.textureX, this.textureY);
        ...
        this.headModel[10] = new ModelRendererTurbo((ModelBase)this, 70, 93, this.textureX, this.textureY);
        this.headModel[11] = new ModelRendererTurbo((ModelBase)this, 70, 93, this.textureX, this.textureY);
        this.headModel[12] = new ModelRendererTurbo((ModelBase)this, 68, 66, this.textureX, this.textureY);
        this.headModel[13] = new ModelRendererTurbo((ModelBase)this, 68, 66, this.textureX, this.textureY);
